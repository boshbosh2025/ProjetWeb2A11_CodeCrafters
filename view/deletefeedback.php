...
<body>
    ...
    ?>
        ...
        <form id="feedback" action="" method="POST">
            ...
            <input class="form-control form-control-user" type="text" id="name" name="name" value="<?php echo $feedback['nom complet'] ?>"><br>
            ...
            <input class="form-control form-control-user" type="text" id="price" name="price" value="<?php echo $feedback['nom matiére'] ?>"><br>
            
            <label for="title">email</label>
            <input class="form-control form-control-user" type="text" id="email" name="email" value="<?php echo $feedback['email'] ?>"><br>
            
            <label for="title">description</label>
            <input class="form-control form-control-user" type="text" id="message" name="message" value="<?php echo $feedback['description'] ?>"><br>
